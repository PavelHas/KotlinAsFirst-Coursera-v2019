...
class Tests {
    ...
    fun russian() {
        ...
        // my
        assertEquals("девятьсот одиннадцать тысяч четыреста семьдесят один", russian(911471))
        assertEquals("двенадцать тысяч четыреста семьдесят один", russian(12471))
        assertEquals("сто шесть тысяч шестьсот девяносто", russian(106690))
        assertEquals("двести девятнадцать тысяч триста", russian(219300))
        assertEquals("триста тринадцать тысяч пятьсот семьдесят", russian(313570))
    }
}